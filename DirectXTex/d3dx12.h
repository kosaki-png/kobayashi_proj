...
struct CD3DX12_STATIC_SAMPLER_DESC : public D3D12_STATIC_SAMPLER_DESC
{
    ...
    CD3DX12_STATIC_SAMPLER_DESC(
         ...
         //D3D12_STATIC_BORDER_COLOR borderColor = D3D12_STATIC_BORDER_COLOR_OPAQUE_BLACK         // uvスクロール時 黒 を流す
         D3D12_STATIC_BORDER_COLOR borderColor = D3D12_STATIC_BORDER_COLOR_TRANSPARENT_BLACK  //      〃   　　透過を流す
        ,
         FLOAT minLOD = 0.f,
